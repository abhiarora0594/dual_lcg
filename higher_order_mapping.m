...
% coords(1,:) = [1.0000000000000000 0.0000000000000000 0.0000000000000000];
% coords(2,:) = [0.9858208890000000 0.0000000000000000 0.0000000000000000];
% coords(3,:) = [0.9857366680000000 -0.0201696847000000 0.0000000000000000];
% coords(4,:) = [0.9997997880000000 -0.0200088099000000 0.0000000000000000];
...
% % % % 
coords(1,:) = [0.9997997880000000 0.0200088099000000 0.0000000000000000];
coords(2,:) = [0.9845005270000000 0.0222788677000000 0.0000000000000000];
coords(3,:) = [0.9858208890000000 0.0000000000000000 0.0000000000000000]; 
coords(4,:) = [1.0000000000000000 0.0000000000000000 0.0000000000000000];
...
% derivatives at the center of the element
dpsi_c(1,1) = -sqrt(3)*0.25; dpsi_c(2,1) = sqrt(3)*0.25;
dpsi_c(3,1) = sqrt(3)*0.25; dpsi_c(4,1) = -sqrt(3)*0.25;

dpsi_c(1,2) = -sqrt(3)*0.25; dpsi_c(2,2) = -sqrt(3)*0.25;
dpsi_c(3,2) = sqrt(3)*0.25; dpsi_c(4,2) = sqrt(3)*0.25;
...
for i=1:4
    d_x_gp = d_x_gp + dpsi_c(i,1)*x_gp(i,1);
end
...
for i=1:ngp
    ...
    for p=1:4
        ...
        fe(p,1) = psi(i,p)*F_gp(i,1,1) - psi(i,p)*d_x_gp;
